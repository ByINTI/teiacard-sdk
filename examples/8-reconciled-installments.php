...
echo "\n\n# Inicio do teste de envio de Parcelas Conciliadas\n";
...
try {
    ...
    echo "\n# Criando de consulta de Parcelas...\n";
    $parcelas = new Parcela();
    $parcelas->setTipo('venda')
             ->setData('20190120')
             ->setTipoServico(1)
             ->setAdquirenteId(1)
             ->setEmpresaCodigo(1)
    ...
    echo "\n# Iniciando consulta de parcelas...\n";
    $teiaCard->parcelas()->setParcela($parcelas);
    $response = $teiaCard->parcelas()->list();
    ...
    echo "\n\n# Teste de consulta de parcelas consolidadas realizado com sucesso!\n\n";
